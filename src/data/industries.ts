...
export const industries: Industry[] = [
  {
    ...
    longDescription: 'Comprehensive security and technology services designed to meet the stringent requirements of the banking and financial sector, from branch security to data center infrastructure.',
