...
function __OriginkitBase_PieBurst(props: Props) {
    const {
    ...
    live.current = {
        base: parseColor(baseColor, [1, 1, 1]),
        acc: parseColor(accentColor, [1, 0.29, 0.12]),
        speed,
        distance,
...
export default function PieBurst(props: Record<string, unknown>) {
  return <__OriginkitBase_PieBurst {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
