...
function __OriginkitBase_OrbNest(props: Props) {
    const {
        style,
        dotColor = "#F4F1EA",
        accentColor = "#00FFCB",
...
export default function OrbNest(props: Record<string, unknown>) {
  return <__OriginkitBase_OrbNest {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
