...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="whatsapp-widget-container" ref={popupRef}>
      {/* Popup Box */}
      <div className={`whatsapp-popup ${isOpen ? 'is-open' : ''}`}>
        {/* Header */}
        <div className="whatsapp-popup-header">
          ...
          <div className="whatsapp-popup-header-info">
            <h4 className="whatsapp-popup-title">SST</h4>
            <div className="whatsapp-popup-status">
        ...
        <div className="whatsapp-popup-body">
          <div className="whatsapp-chat-bubble">
            <span role="img" aria-label="wave">👋</span> Hello! Welcome to <strong>SST</strong>. How can we help you build your digital portal or software project today?
          </div>
          <div className="whatsapp-popup-footer-text">
            DIRECT WHATSAPP HELPLINE: +91 94941 39156
          </div>
        </div>

        {/* Input Area */}
        <div className="whatsapp-popup-input-area">
          <textarea 
          ...
          />
          <button className="whatsapp-popup-submit" onClick={handleSend}>
